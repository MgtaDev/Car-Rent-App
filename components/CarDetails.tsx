  ...
  return (
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as='div' className='relative z-10' onClose={closeModal}>
        ...
        transform rounded-2xl bg-white textleft p-6 shadow-xl transition-all flex flex-col gap-5
        '>
          ...
          <div className="flex-1 relative w-full h-24 bg-primary-blue-100 align-center rounded-lg"> 
